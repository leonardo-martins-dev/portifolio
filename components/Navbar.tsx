...
const Navbar: React.FC<{}> = () => {
  ...
  return (
    <div className="w-full h-[65px] bg-['#111'] fixed backdrop-blur-sm z-50 px-4 sm:px-6 md:px-10">
      <div className="w-full h-full flex flex-row items-center justify-end m-auto px-2 sm:px-[10px]">
        <div className="flex flex-row gap-3 sm:gap-5">
          <div
            ...
            className="z-[1] bg-transparent padding-10 cursor-pointer bg-black hover:bg-[#2E2E2E] rounded-xl text-white py-2 px-3 sm:px-5 text-sm sm:text-base transition-colors duration-200"
          >
            Contato
          </div>
        </div>
